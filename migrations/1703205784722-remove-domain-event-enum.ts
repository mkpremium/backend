...
export class RemoveDomainEventEnum1703205784722 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "domain_event" DROP COLUMN "name"`);
        await queryRunner.query(`DROP TYPE "public"."domain_event_name_enum"`);
        await queryRunner.query(`ALTER TABLE "domain_event" ADD "name" text NOT NULL`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "domain_event" ADD "name" "public"."domain_event_name_enum" NOT NULL`);
    }
