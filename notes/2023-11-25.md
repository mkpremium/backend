...
```/opt/couchbase/bin/cbtransfer http://localhost:8091 http://localhost:8091 -u couchbase -p couchbase -B mkpremium -b backup_2020_02_01 --destination-operation=add```
