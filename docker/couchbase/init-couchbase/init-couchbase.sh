...
COUCHBASE_USERNAME=${COUCHBASE_USERNAME:-couchbase-user}
COUCHBASE_PASSWORD=${COUCHBASE_PASSWORD:-couchbase-password}
...
COUCHBASE_BUCKET_RAM_SIZE=${COUCHBASE_BUCKET_RAM_SIZE:-100}
